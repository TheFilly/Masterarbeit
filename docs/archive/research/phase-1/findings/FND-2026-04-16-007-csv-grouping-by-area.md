...
The CSV-family artifacts under `DicomData/` can be grouped cleanly by the requested dataset areas, but the operational role of those CSV files differs across areas.
