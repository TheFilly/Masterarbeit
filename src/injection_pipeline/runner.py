...
# Input: `args` with validated CLI or interactive run parameters.
# Output: No return value; writes run artifacts to disk.
# The function preserves the prototype orchestration behavior behind the package CLI.
